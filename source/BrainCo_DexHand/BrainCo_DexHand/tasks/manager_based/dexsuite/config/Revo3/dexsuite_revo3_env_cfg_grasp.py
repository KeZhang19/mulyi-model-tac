...
TIANJI_PALM_BODY_NAME = "right_palm"
...
TIANJI_PRESSURE_PAD_COLLISION_LINK_ORDER = tuple(
    f"right_{TIANJI_PRESSURE_PAD_FINGER_STEMS[finger]}{segment}_roll_link"
    for finger in TIANJI_RL_FINGER_ORDER
    for segment in TIANJI_PRESSURE_PAD_SEGMENTS
)
...
TIANJI_TACMAP_DIR = TACMAP_ROOT / "assets" / "tactilesensor_map" / "revo21_dv2"
...
def _make_tacmap_link_surface_cfg(
    ...
    *,
    ...
    target_expr = "{ENV_REGEX_NS}/Object" if sensor_kind == "object" else f"{{ENV_REGEX_NS}}/Robot/{link_name}"
    ...
    def __post_init__(self: dexsuite.DexsuiteReorientEnvCfg):
            ...
            for link_name, sensor_name in zip(
                ...
                setattr(
                    ...
                    WarpSdfTactileSensorCfg(
                        ...
                        elastomer_prim_paths=[f"{ISAACLAB_ENV_REGEX_NS}/Robot/{link_name}"],
                        num_rows=rows,
                        num_cols=cols,
        ...
        if tactile_implementation == "ours":
            ours_component_cfg = {
                ...
                "hydroshear_marker_finger_link_names": list(TIANJI_TACMAP_LINK_ORDER),
                "hydroshear_object_sample_mode": "poisson",
                "hydroshear_object_sample_count": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_COUNT,
                "hydroshear_object_sample_seed": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_SEED,
                "hydroshear_object_poisson_radius": mdp.RL_HYDROSHEAR_POISSON_RADIUS,
                "hydroshear_object_poisson_initial_count": mdp.RL_HYDROSHEAR_POISSON_INITIAL_COUNT,
                "hydroshear_object_sample_reference_count": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_REFERENCE_COUNT,
                "hydroshear_object_sample_roi_count": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_ROI_COUNT,
            ...
            self.observations.proprio.rl_tacsl_baseline = ObsTerm(
                ...
                params={
                    "tacmap_sensor_names": list(TIANJI_TACMAP_OBJECT_SENSOR_NAMES),
                    "tacmap_surface_sensor_names": list(TIANJI_TACMAP_SURFACE_SENSOR_NAMES),
                    "finger_link_names": list(TIANJI_TACMAP_LINK_ORDER),
            ...
            self.observations.proprio.rl_hydroshear_baseline = ObsTerm(
                ...
                params={
                    ...
                    "object_sample_count": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_COUNT,
                    "object_sample_seed": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_SEED,
                    "object_poisson_radius": mdp.RL_HYDROSHEAR_POISSON_RADIUS,
                    "object_poisson_initial_count": mdp.RL_HYDROSHEAR_POISSON_INITIAL_COUNT,
                    "object_sample_reference_count": mdp.RL_HYDROSHEAR_OBJECT_SAMPLE_REFERENCE_COUNT,
                },
            )
        ...
        self.events.zz_revo3_touch_compliant_materials = EventTerm(
            ...
            mode="startup",
            params={
                "link_names": tuple(TIANJI_TACMAP_LINK_ORDER),
