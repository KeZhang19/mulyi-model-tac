...
_LOCAL_GROUND_USD = str(
    Path(__file__).resolve().parents[8] / "assets" / "usd" / "ground" / "default_environment.usd"
)
...
class ObservationsCfg:
    ...
    class ProprioObsCfg(ObsGroup):
        ...
        rl_ours: ObsTerm | None = None
        rl_ours_pressure: ObsTerm | None = None
        rl_ours_tacmap_policy: ObsTerm | None = None
        rl_ours_hydroshear: ObsTerm | None = None
        rl_ours_taxim_rgb: ObsTerm | None = None
        rl_tacsl_baseline: ObsTerm | None = None
        rl_hydroshear_baseline: ObsTerm | None = None
        rl_fots_baseline: ObsTerm | None = None
        rl_warpsdf_pressure: ObsTerm = MISSING
        rl_tacmap: ObsTerm | None = None
        rl_hydroshear: ObsTerm | None = None
