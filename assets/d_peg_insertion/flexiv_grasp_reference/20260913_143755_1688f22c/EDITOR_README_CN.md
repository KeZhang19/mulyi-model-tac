...
| 7 | right_thumb_CMP_joint | 右手拇指 CMP 关节（模型命名） | 1.647014521 | 94.366981 | 7 | 7 |
| 8 | right_thumb_CMR_joint | 右手拇指 CMR 关节（模型命名） | 1.411206391 | 80.85617 | 8 | 8 |
| 9 | right_thumb_MCP_joint | 右手拇指 MCP 关节（模型命名） | 0.2961324048 | 16.967137 | 9 | 9 |
| 10 | right_thumb_PIP_joint | 右手拇指 PIP 关节（模型命名） | 0.2464328541 | 14.119562 | 10 | 10 |
| 11 | right_thumb_DIP_joint | 右手拇指 DIP 关节（模型命名） | 0.1126743363 | 6.4557639 | 11 | 11 |
| 12 | right_index_MPR_joint | 右手食指 MPR 关节（模型命名） | 0.1115948428 | 6.3939135 | 12 | 12 |
| 13 | right_index_MCP_joint | 右手食指 MCP 关节（模型命名） | 1.208067394 | 69.217163 | 13 | 13 |
| 14 | right_index_PIP_joint | 右手食指 PIP 关节（模型命名） | 0.3709299368 | 21.25272 | 14 | 14 |
| 15 | right_index_DIP_joint | 右手食指 DIP 关节（模型命名） | 0.2941155765 | 16.851581 | 15 | 15 |
| 16 | right_middle_MPR_joint | 右手中指 MPR 关节（模型命名） | -0.06783623429 | -3.8867299 | 16 | 16 |
| 17 | right_middle_MCP_joint | 右手中指 MCP 关节（模型命名） | 1.068534727 | 61.22253 | 17 | 17 |
| 18 | right_middle_PIP_joint | 右手中指 PIP 关节（模型命名） | 0.4036127167 | 23.125305 | 18 | 18 |
| 19 | right_middle_DIP_joint | 右手中指 DIP 关节（模型命名） | 0.3500618276 | 20.057065 | 19 | 19 |
| 20 | right_ring_MPR_joint | 右手无名指 MPR 关节（模型命名） | -0.0009887062179 | -0.056648693 | 20 | 20 |
| 21 | right_ring_MCP_joint | 右手无名指 MCP 关节（模型命名） | 1.060264782 | 60.748697 | 21 | 21 |
| 22 | right_ring_PIP_joint | 右手无名指 PIP 关节（模型命名） | 0.2970115493 | 17.017508 | 22 | 22 |
| 23 | right_ring_DIP_joint | 右手无名指 DIP 关节（模型命名） | 0.3035747316 | 17.393551 | 23 | 23 |
| 24 | right_little_MPR_joint | 右手小指 MPR 关节（模型命名） | -0.1427512237 | -8.1790426 | 24 | 24 |
| 25 | right_little_MCP_joint | 右手小指 MCP 关节（模型命名） | 1.223691249 | 70.112344 | 25 | 25 |
| 26 | right_little_PIP_joint | 右手小指 PIP 关节（模型命名） | 0.2732384904 | 15.655412 | 26 | 26 |
| 27 | right_little_DIP_joint | 右手小指 DIP 关节（模型命名） | 0.1548349052 | 8.8713866 | 27 | 27 |
...
求解收敛：`False`；姿态候选通过：`False`。
最大标注接触距离：`0.022240766218743904` m；最大穿透：`0.004733773245376198` m。
